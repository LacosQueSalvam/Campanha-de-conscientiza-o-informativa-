...
const Chatbot: React.FC<ChatbotProps> = ({ activeCampaign }) => {
  ...
  useEffect(() => {
    // Vercel and other bundlers replace `import.meta.env.VITE_...` with the actual value at build time.
    // FIX: Per coding guidelines, API key must be retrieved from process.env.API_KEY. This also resolves the TypeScript error.
